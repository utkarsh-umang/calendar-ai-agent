...
- **Background memory extraction** — implicit pattern detection (recurring meetings, preferred durations) would require a periodic job analysing calendar history
